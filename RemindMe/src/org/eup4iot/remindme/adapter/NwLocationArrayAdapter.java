...
public class NwLocationArrayAdapter extends ArrayAdapter<Location> {

    /** The tag. */
    private final String TAG = NwLocationArrayAdapter.this.getClass().getSimpleName();
    ...
    public NwLocationArrayAdapter(Context context, int textViewResourceId, List<Location> items) {
