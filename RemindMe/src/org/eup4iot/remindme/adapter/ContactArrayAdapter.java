...
import org.eup4iot.remindme.ContactFragment;
...
public class ContactArrayAdapter extends ArrayAdapter<User> {
    ...
    /** The tag. */
    private final String TAG = ContactArrayAdapter.this.getClass().getSimpleName();
    ...
    public ContactArrayAdapter(Context context, int textViewResourceId, List<User> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
	        if (convertView == null) {
	            ...
	            holder.item_switch = (Switch) convertView.findViewById(R.id.contact_switch);
	        ...
	        final User dElement = getItem(position);
	        
	        if(dElement != null) {
	        	holder.item_name.setText(dElement.getUserFullName());
		    	holder.item_switch.setChecked(dElement.isSelected());
	        	
		        if (dElement.getUserIconURL() != null) {
					...
					String imageUrl = dElement.getUserIconURL();
		            ...
		            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		            	...
		            	if(isChecked == true) {
		            		...
		            		if(ContactFragment.contactFragment != null) {
		            			ContactFragment.contactFragment.changeSwitchStatus(position, true);
		            		}
		            	} else {
		            		if(ContactFragment.contactFragment != null) {
		            			ContactFragment.contactFragment.changeSwitchStatus(position, false);
		            		}
		            	}
		            }
		        });
